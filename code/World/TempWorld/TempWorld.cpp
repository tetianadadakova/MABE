...
shared_ptr<ParameterLink<int>> TempWorld::evaluationsPerGenerationPL =
...
TempWorld::TempWorld(shared_ptr<ParametersTable> PT_) : AbstractWorld(PT_) {
...
auto TempWorld::evaluate(map<string, shared_ptr<Group>>& groups, int analyze, int visualize, int debug) -> void {
...
auto TempWorld::requiredGroups() -> unordered_map<string,unordered_set<string>> {
